...
vit_final_gadm2 <- read_csv("./ar.2023.update.using.2021.pol.data/data/output/[finalizedApr2023]gadm2_aqli2021_vit.csv")
vit_final_gadm1 <- read_csv("./ar.2023.update.using.2021.pol.data/data/output/[finalizedApr2023]gadm1_aqli2021_vit.csv")
vit_final_gadm0 <- read_csv("./ar.2023.update.using.2021.pol.data/data/output/[finalizedApr2023]gadm0_aqli2021_vit.csv")
...
# export anti joined files for ViT

aqli_gadm2_collapse_master_finalized_rotw_pov_vit %>% 
  write_csv(str_c(pov_files_folder_path, "rotw/", "[May2023]gadm2_aqli_2021_rotw_pov_usingViTColnamesCompletely.csv"))
