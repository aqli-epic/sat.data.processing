...
# For gadm 0, 1 and 2 write the final versions (both geom and non-geom) of files, incorporating all remaining ViT column name changes/drop requests, add notes from the sticky notes (and then remove the sticky notes comment) and wrap this up!!!.
