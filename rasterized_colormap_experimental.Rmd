...
region_raster_brick_df %>% arrow::write_dataset("./experimentation/arrow_r_test/polDataOnly_2.csv", format = "csv")

# benchmarking
threshold_6 <- Sys.time()

region_raster_brick_df_light <- arrow::open_dataset("./experimentation/arrow_r_test/polDataOnly_2.csv", format = "csv")
