...
# rename: country, name_1, name_2 AND remove iso_alpha3, natstandard, whostandard
aqli_gadm2_collapse_master %>%
...
# rename country to name0 AND remove whostandard, also add an ungroup statement, when this dataset was created up top, to be safe.
aqli_gadm0_collapse_from_gadm2 %>%
