...
#> test regional summary function and then run it on zero population regions with normal (i.e. with full mask) 2018 population file. Then test with "no land mask" to see if it helps

# read in the file that lists all 0 population regions
zero_pop <- read_csv("./experimentation/zero_population_regions.csv")

foo <- regional_summary(colormap, "C:/Users/Aarsh/Desktop/aqli-epic/sat.data.processing/experimentation/full_mask_2018_0.01/", pop_raw_landscan_crop_pol, 0.001, zero_pop$obj_id, 2018, 0.008)

foo1 <- regional_summary(colormap, "C:/Users/Aarsh/Desktop/aqli-epic/sat.data.processing/experimentation/no_land_mask_2018_0.01/", pop_raw_landscan_crop_pol, 0.001, zero_pop$obj_id, 2018, 0.008)


foo_10m <- regional_summary(colormap, "C:/Users/Aarsh/Desktop/aqli-epic/sat.data.processing/experimentation/full_mask_2018_0.01/", pop_raw_landscan_crop_pol, 0.0001, zero_pop$obj_id, 2018, 0.008)
