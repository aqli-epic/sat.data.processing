...
# pollution raw data
pollution_dataset <- raster::raster("./ar.2023.update.using.2021.pol.data/data/input/pollution/0.01x0.01/foo_2020.nc")
  
# population raw data
population_dataset <- raster::raster("./ar.2023.update.using.2021.pol.data/data/input/population/landscan-global-2021.tif")

# load latest colormap shapefile for (last complete updated: November, 2022)
colormap <- st_read("./ar.2023.update.using.2021.pol.data/data/intermediate/1_population_and_colormap/1_shapefile_aggregate/colormap/colormap.shp")

# load the latest hover shapefile (last complete update: November, 2022)
hovermap <- st_read("./ar.2023.update.using.2021.pol.data/data/intermediate/1_population_and_colormap/1_shapefile_aggregate/hover/hover.shp") %>%
  rename(objectid_hover = objectid)


# read color hover crosswalk
gadm_hover_color_crosswalk <- readxl::read_excel("./ar.2023.update.using.2021.pol.data/data/intermediate/1_population_and_colormap/1_shapefile_aggregate/crosswalks/gadm_hover_color/gadm_hover_color_crosswalk.xlsx")
...
pollution_district_wise_matched_colormap
